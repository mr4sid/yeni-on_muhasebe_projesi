# api/rotalar/nitelikler.py Dosyasının tam içeriği
...
def create_kategori(kategori: modeller.UrunKategoriCreate, db: Session = Depends(veritabani.get_db), current_user=Depends(guvenlik.get_current_user)):
...
def read_kategoriler(skip: int = 0, limit: int = 1000, arama: str = Query(None), db: Session = Depends(veritabani.get_db), current_user=Depends(guvenlik.get_current_user)):
...
def read_kategori(kategori_id: int, db: Session = Depends(veritabani.get_db), current_user=Depends(guvenlik.get_current_user)):
...
def update_kategori(kategori_id: int, kategori: modeller.UrunKategoriUpdate, db: Session = Depends(veritabani.get_db), current_user=Depends(guvenlik.get_current_user)):
...
def delete_kategori(kategori_id: int, db: Session = Depends(veritabani.get_db), current_user=Depends(guvenlik.get_current_user)):
    db_kategori = db.query(modeller.UrunKategori).filter(modeller.UrunKategori.id == kategori_id).first()
    if not db_kategori:
        raise HTTPException(status_code=status.HTTP_404_NOT_FOUND, detail="Kategori bulunamadı")
...
def create_marka(marka: modeller.UrunMarkaCreate, db: Session = Depends(veritabani.get_db), current_user=Depends(guvenlik.get_current_user)):
...
def read_markalar(skip: int = 0, limit: int = 1000, arama: str = Query(None), db: Session = Depends(veritabani.get_db), current_user=Depends(guvenlik.get_current_user)):
...
def read_marka(marka_id: int, db: Session = Depends(veritabani.get_db), current_user=Depends(guvenlik.get_current_user)):
...
def update_marka(marka_id: int, marka: modeller.UrunMarkaUpdate, db: Session = Depends(veritabani.get_db), current_user=Depends(guvenlik.get_current_user)):
...
def delete_marka(marka_id: int, db: Session = Depends(veritabani.get_db), current_user=Depends(guvenlik.get_current_user)):
...
def create_urun_grubu(urun_grubu: modeller.UrunGrubuCreate, db: Session = Depends(veritabani.get_db), current_user=Depends(guvenlik.get_current_user)):
...
def read_urun_grubu(urun_grubu_id: int, db: Session = Depends(veritabani.get_db), current_user=Depends(guvenlik.get_current_user)):
...
def update_urun_grubu(urun_grubu_id: int, urun_grubu: modeller.UrunGrubuUpdate, db: Session = Depends(veritabani.get_db), current_user=Depends(guvenlik.get_current_user)):
...
def delete_urun_grubu(urun_grubu_id: int, db: Session = Depends(veritabani.get_db), current_user=Depends(guvenlik.get_current_user)):
...
def create_urun_birimi(urun_birimi: modeller.UrunBirimiCreate, db: Session = Depends(veritabani.get_db), current_user=Depends(guvenlik.get_current_user)):
...
def read_urun_birimi(urun_birimi_id: int, db: Session = Depends(veritabani.get_db), current_user=Depends(guvenlik.get_current_user)):
...
def update_urun_birimi(urun_birimi_id: int, urun_birimi: modeller.UrunBirimiUpdate, db: Session = Depends(veritabani.get_db), current_user=Depends(guvenlik.get_current_user)):
...
def delete_urun_birimi(urun_birimi_id: int, db: Session = Depends(veritabani.get_db), current_user=Depends(guvenlik.get_current_user)):
...
def create_ulke(ulke: modeller.UlkeCreate, db: Session = Depends(veritabani.get_db), current_user=Depends(guvenlik.get_current_user)):
...
def read_ulke(ulke_id: int, db: Session = Depends(veritabani.get_db), current_user=Depends(guvenlik.get_current_user)):
...
def update_ulke(ulke_id: int, ulke: modeller.UlkeUpdate, db: Session = Depends(veritabani.get_db), current_user=Depends(guvenlik.get_current_user)):
...
def delete_ulke(ulke_id: int, db: Session = Depends(veritabani.get_db), current_user=Depends(guvenlik.get_current_user)):
...
def create_gelir_siniflandirma(siniflandirma: modeller.GelirSiniflandirmaCreate, db: Session = Depends(veritabani.get_db), current_user=Depends(guvenlik.get_current_user)):
...
def read_gelir_siniflandirma(siniflandirma_id: int, db: Session = Depends(veritabani.get_db), current_user=Depends(guvenlik.get_current_user)):
...
def update_gelir_siniflandirma(siniflandirma_id: int, siniflandirma: modeller.GelirSiniflandirmaUpdate, db: Session = Depends(veritabani.get_db), current_user=Depends(guvenlik.get_current_user)):
...
def delete_gelir_siniflandirma(siniflandirma_id: int, db: Session = Depends(veritabani.get_db), current_user=Depends(guvenlik.get_current_user)):
...
def create_gider_siniflandirma(siniflandirma: modeller.GiderSiniflandirmaCreate, db: Session = Depends(veritabani.get_db), current_user=Depends(guvenlik.get_current_user)):
...
def read_gider_siniflandirma(siniflandirma_id: int, db: Session = Depends(veritabani.get_db), current_user=Depends(guvenlik.get_current_user)):
...
def update_gider_siniflandirma(siniflandirma_id: int, siniflandirma: modeller.GiderSiniflandirmaUpdate, db: Session = Depends(veritabani.get_db), current_user=Depends(guvenlik.get_current_user)):
...
def delete_gider_siniflandirma(siniflandirma_id: int, db: Session = Depends(veritabani.get_db), current_user=Depends(guvenlik.get_current_user)):
